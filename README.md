...
RU: Туториал: 1. открыть ссылку https://html-opener-nyawkz.netlify.app
...
(P.S. кнопка вставить не работает, просто очищаете нажимаете на окно и вставляете вручную)

EN: Tutorial: 1. open the link https://html-opener-nyawkz.netlify.app
...
(P.S. the paste button doesn't work, so just clear the window and paste manually)
